        ...
        <section className='container mx-auto mt-100'>
            ...
            <ul  className='flex justify-around items-center mx-auto w-full p-24 bg-white rounded-6 mt-100'>  
                {imgData.map((item) => (
                    ...
                    <li key={item.id} className='p-20'><img src={img} alt={item.alt} />  </li>
                ))}
