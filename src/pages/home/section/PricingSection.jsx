    ...
    return (
        <section className="container mx-auto mt-100  rounded-6">
            ...
            <div className="flex justify-center items-center gap-20 p-10 rounded-6 bg-white table1005:mt-30  ">
                <PriceButton2><span onClick={yearFunc}>Monthly</span></PriceButton2>
                <PriceButton><span onClick={yearFunc}>Yearly</span></PriceButton>
        ...
        <PricingCard1 text="Year" number="790$"  type={year}/>
        <PricingCard2  text="Year" number="790$" />
        </div>
