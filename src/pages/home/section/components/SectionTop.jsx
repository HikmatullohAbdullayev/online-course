...
function SectionTop(props) {
    return (
       ...
       <div className="flex justify-between flex-col mx-10 mobil2:flex mobil2:flex-col mobil2:items-start ">
          ...
          <p className=' hidden py-18 px-10 ml-20 bg-white rounded-6 shadow-sm cursor-pointer font-500 text-text18 hover:bg-primary hover:text-white table:py-14 table:px-18 tablemin:py-8 tablemin:px16 tablemin:text-text16 mobile530:text-text14 mobil2:block'>View All</p>
        </div>
        </>
    );
}
