    ...
    return (
       ...
       <div className="flex justify-between flex-col ">
            <div className=" w-full px-20 flex justify-between items-center mb-6">
                ...
                <p className='py-18 px-24 bg-white rounded-6 shadow-sm cursor-pointer font-500 text-text18 hover:bg-primary hover:text-white table:py-14 table:px-18 tablemin:py-8 tablemin:px16 tablemin:text-text16 mobile530:text-text14'>View All</p>
             
            </div>
          <div className="max-w-[1000px] w-full p-20 ">  <p className='font-400 text-text18 text-text w-full mobile530:text-text14'>Lorem ipsum dolor sit amet consectetur. Tempus tincidunt etiam eget elit id imperdiet et. Cras eu sit dignissim lorem nibh et. Ac cum eget habitasse in velit fringilla feugiat senectus in.</p></div>
        </div>
        </>
    );
}
