    ...
    return (
       ...
       <div className="flex justify-between flex-col mobil2:flex mobil2:flex-col mobil2:items-start ">
            <div className=" w-full px-20 flex justify-between items-center mb-6  ">
                ...
                <p className='py-18 px-24 bg-white rounded-6 shadow-sm cursor-pointer font-500 text-text18 hover:bg-primary hover:text-white table:py-14 table:px-18 tablemin:py-8 tablemin:px16 tablemin:text-text16 mobile530:text-text14 mobil2:hidden'>View All</p>
